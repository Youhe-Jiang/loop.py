...
class TestUnevenParamShard(FSDPTest):
    ...
    def test_one_iteration(self):
        ...
        with torch.profiler.profile(
            ...
            on_trace_ready=torch.profiler.tensorboard_trace_handler('../num-20/OVERALLTEST/model_6/100'),
            record_shapes=True,
            profile_memory=True,
            with_stack=True,
            with_flops=True,
        ...
        with torch.profiler.profile(
            schedule=torch.profiler.schedule(wait=1, warmup=1, active=3, repeat=2),
            on_trace_ready=torch.profiler.tensorboard_trace_handler('../num-20/OVERALLTEST/model_6/200'),
            record_shapes=True,
            profile_memory=True,
            with_stack=True,
            with_flops=True,
        ...
        with torch.profiler.profile(
            schedule=torch.profiler.schedule(wait=1, warmup=1, active=3, repeat=2),
            on_trace_ready=torch.profiler.tensorboard_trace_handler('../num-20/OVERALLTEST/model_6/300'),
            record_shapes=True,
            profile_memory=True,
            with_stack=True,
            with_flops=True,
        ...
        with torch.profiler.profile(
            schedule=torch.profiler.schedule(wait=1, warmup=1, active=3, repeat=2),
            on_trace_ready=torch.profiler.tensorboard_trace_handler('../num-20/OVERALLTEST/model_6/400'),
            record_shapes=True,
            profile_memory=True,
            with_stack=True,
            with_flops=True,
        ...
        with torch.profiler.profile(
            schedule=torch.profiler.schedule(wait=1, warmup=1, active=3, repeat=2),
            on_trace_ready=torch.profiler.tensorboard_trace_handler('../num-20/OVERALLTEST/model_6/500'),
            record_shapes=True,
            profile_memory=True,
            with_stack=True,
            with_flops=True,
        ...
        with torch.profiler.profile(
            schedule=torch.profiler.schedule(wait=1, warmup=1, active=3, repeat=2),
            on_trace_ready=torch.profiler.tensorboard_trace_handler('../num-20/OVERALLTEST/model_6/600'),
            record_shapes=True,
            profile_memory=True,
            with_stack=True,
            with_flops=True,
        ...
        with torch.profiler.profile(
            schedule=torch.profiler.schedule(wait=1, warmup=1, active=3, repeat=2),
            on_trace_ready=torch.profiler.tensorboard_trace_handler('../num-20/OVERALLTEST/model_6/700'),
            record_shapes=True,
            profile_memory=True,
            with_stack=True,
            with_flops=True,
        ...
        with torch.profiler.profile(
            schedule=torch.profiler.schedule(wait=1, warmup=1, active=3, repeat=2),
            on_trace_ready=torch.profiler.tensorboard_trace_handler('../num-20/OVERALLTEST/model_6/800'),
            record_shapes=True,
            profile_memory=True,
            with_stack=True,
            with_flops=True,
        ...
        with torch.profiler.profile(
            schedule=torch.profiler.schedule(wait=1, warmup=1, active=3, repeat=2),
            on_trace_ready=torch.profiler.tensorboard_trace_handler('../num-20/OVERALLTEST/model_6/900'),
            record_shapes=True,
            profile_memory=True,
            with_stack=True,
            with_flops=True,
        ...
        with torch.profiler.profile(
            schedule=torch.profiler.schedule(wait=1, warmup=1, active=3, repeat=2),
            on_trace_ready=torch.profiler.tensorboard_trace_handler('../num-20/OVERALLTEST/model_6/1000'),
            record_shapes=True,
            profile_memory=True,
            with_stack=True,
            with_flops=True,
